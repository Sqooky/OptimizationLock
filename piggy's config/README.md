To install The changes to the video.txt you need to manually edit the file. Make sure everything in the piggy video.txt is pasted directly under your DeviceID.
Your prexisting video.txt can be found at steamapps/common/deadlock/game/citadel/cfg/video.txt
...
"setting.defaultres" "1920"                // Change to your res | 1920
"setting.defaultresheight" "1080"            // Change to your res | 1080
"setting.recommendedheight" "1080"            // Change to your res | 1080 
"setting.refreshrate_numerator" "144"        // Change to your monitor hz: 144Hz | 240Hz ect 
...
"setting.fps_max" "0"   				// Change to cap fps (Leave at 0 if using RTSS)
...
"setting.r_dlss_preset" "0"
"setting.r_citadel_fsr_rcas_sharpness" "0"
"setting.r_citadel_fsr2_sharpness" "0"
...
// 4 is the lowest you can go without adding sinner light mod (8 is the lowest aka roblox)
// ==================================
...
"setting.cl_particle_fallback_base" "6"
