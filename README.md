...
| [Boot's Max Fps](https://github.com/Sqooky/OptimizationLock/blob/main/gameinfo.gi)                                    | Heavily performance oriented, currently this config gives the best fps out of all configs tested.
