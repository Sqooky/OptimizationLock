...
**There is a video tutorial** for installation avalible [here](www.youtube.com/watch?v=ZKyJP3u-Y60)
...
``r_aspectratio``
``citadel_camera_hero_fov`` Adjust these two values to your liking.  
