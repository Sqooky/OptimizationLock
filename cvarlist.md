...
citadel_announcement_display_time |  | 4 | devonly, cl
...
citadel_modifier_hud_message_display_clear |  | false | devonly, cl
citadel_modifier_hud_message_display_min_panel_count |  | 4 | devonly, cl
citadel_modifier_hud_message_display_time |  | 2.5 | devonly, cl
...
citadel_super_trooper_gold_mult | Mult Gold Bounty from Super Troopers by this amount | 0.85 | devonly, sv, rep
...
citadel_tweak_hero_base_health | Command to tweak base health.  Pass in scale factor and constant increase | cmd | devonly, cl
citadel_tweak_hero_level_boons | Command to tweak level boons.  Pass in scale factor | cmd | devonly, cl
citadel_tweak_hero_level_boons_health | Command to tweak level boons for health.  Pass in scale factor and fixed increase | cmd | devonly, cl
