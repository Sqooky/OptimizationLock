...
mat_async_shader_load                       "1"             // I have no reason to believe it doesn't do what it says on the tin [def: "0"]
...
props_break_max_pieces_perframe             "-1"             // Makes boxes break into single pieces                             [def: "16"]
...
// ================ Test Group 5 ================
// ================ Testing Stuff From Kai's Updated Cfg ================
sv_hide_ent_in_pvs                          "1"             // [def: "-1"]
ai_lod_auto_enabled                         "true"          // not fully sure what this does but curious [def: "false"]
...
//cl_phys_enabled                           "false"         // You can disable physics and might see an improvement in framerate, however ragdolls will be buggy.   [def: "true"]
